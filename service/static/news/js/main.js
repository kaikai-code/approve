$(function(){
    ...
    $('.form_group').on('focusin',function(){
            $(this).children('.input_tip').animate({'top':-5,'font-size':12},'fast').siblings('input').parent().addClass('hotline');
        })
    ...
    $.ajax({
        url: "/passport/login",
        type: "POST",
        data: JSON.stringify(params_dict),
        headers : {
